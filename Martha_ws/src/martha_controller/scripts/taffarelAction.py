...
class Taffarel(object):
    ...
    def move_joint_smoothly(self, publisher, start_position, end_position, duration, lado, joint_index=0):
        rate = 50  # Hz
        steps = rate * duration
        ...
        for i in range(int(steps)):
            ...
            if lado == "esquerdo":
                # Atualizar os dois primeiros valores com os dados do callback
                positions = [
                    0,
                    0,
                    0,
                    int(start_position + delta_position * i),
                    0
                ]
            elif lado == "direito":
                positions = [0, int(start_position + delta_position * i), 0]
    ...
    def CairEsquerda(self):
        ...
        start_position = 0
        end_position = -48  # -280 graus convertidos para radianos
        duration = 2.0
        self.move_joint_smoothly(self.pub_arm_l_head, start_position, end_position, duration, "esquerdo", joint_index=5)

        # Definir posições para pernas e outros membros (em radianos)
        angles_arm_r = [0, 0, 0]
        angles_left_leg = [0, -9, 0, 0, 0, 5]  # -50° e 30° em radianos
        angles_right_leg = [0, -9, 0, 0, 0, 5]  # -50° e 30° em radianos
    ...
    def CairDireita(self):
        ...
        end_position = 48  # 280 graus convertidos para radianos
        duration = 2.0
        self.move_joint_smoothly(self.pub_arm_r, start_position, end_position, duration, "direito", joint_index=3)

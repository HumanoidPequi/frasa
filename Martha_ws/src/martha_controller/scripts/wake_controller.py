...
#      Movimento para levantar o robô de frente usando move_joint_smoothly
     ...
     move_joint_smoothly(pub_l_hip_pitch, 0.0, 1.0, 1.5)
     move_joint_smoothly(pub_r_hip_pitch, 0.0, 0.0, 1.5)
     ...
     move_joint_smoothly(pub_l_hip_pitch, 1,5, 1.0, 0.0)
     move_joint_smoothly(pub_r_hip_pitch, 1.5, 1.0, 0.0)

     move_joint_smoothly(pub_l_knee, 1.5, 1.0, 0.0)
     move_joint_smoothly(pub_r_knee, 1.5, 1.0, 0.0)
 ...
 def levantar_de_tras():
     ...
     move_joint_smoothly(pub_l_knee, 0.0, 1.0, 1.5)
     move_joint_smoothly(pub_r_knee, 0.0, 1.0, 1.5)
     ...
     move_joint_smoothly(pub_l_ankle_pitch, -1.0, -0.5, 0.0)
     move_joint_smoothly(pub_r_ankle_pitch, -1.0, -0.5, 0.0)
